...
**GitHub:** https://github.com/ShonHarsh/RPADev-S05P05-DataScraping-WindowsLegacy
...
```sh
git clone https://github.com/ShonHarsh/RPADev-S05P05-DataScraping-WindowsLegacy
```
